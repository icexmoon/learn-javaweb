...
public class ServletUtil {
     ...
     * @return Cookie值，没找到返回 Null
     */
    public static String getCookieVal(HttpServletRequest req, String cookieName) {
     ...
     */
    public static String dealMessyCode(String messyCode) {
